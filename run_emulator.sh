...
cd assembler && g++ parser.cpp < $FILE -o parser && ./parser && rm parser && cd ../executor && g++ interpreter.cpp -o interpreter && ./interpreter < "..$TEST_FILE" > "../outputs/output.txt" && rm interpreter
